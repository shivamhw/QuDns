...
import { DeleteRecordParams, UpdateRecordParams, UpdateRecordResponse } from '../../../service/recordService';
import { error } from "console";
import { DomainResponse } from '../../../service/domainService'
...
export class ddns {
    ...
    public async listDomains(): Promise<DomainResponse> {
    ...
    public async getRecordsByEmail(): Promise<Record[]> {
